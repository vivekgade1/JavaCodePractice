...
* A parent class cann't be casted to sub class
* A sub class can be casted to parent class
* A parent class instance can't access static or dynamic functions of the child but the reverse is true.
...
* A parent class instance cann't be assigned to a subclass but the reverse is only true.
